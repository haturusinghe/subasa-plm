...
main.py --pretrained_model xlm-roberta-base --val_int 10000 --patience 3 --epochs 1 --batch_size 1 --lr 0.00002 --seed 42 --wandb_project xlmr-base-stage2-42-b16-e5-radam-s42-mrp-msk0.5 --finetuning_stage final --dataset sold --num_labels 2 --mask_ratio 0.5 --test True --test_model_path final_finetune/mrp_0.5_seed42_b16_e5_radam_s42_msk0.5_2_ep5_ckpt/ep5.ckpt --push_to_hub True --intermediate mrp


main.py --pretrained_model xlm-roberta-base --val_int 10000 --patience 3 --epochs 1 --batch_size 1 --lr 0.00002 --seed 42 --wandb_project baseline-without-augmented-2-seed42 --finetuning_stage final --dataset sold --num_labels 2 --mask_ratio 0.5 --test True --test_model_path final_finetune/final_w_mrp_0.5_seed42_ep5_ckpt/ep5.ckpt --push_to_hub True